...
const translations = {
  it: {
    ...
    paymentConfirmedDesc: "Sei ufficialmente iscritto all'evento.",
    backToEvent: "Torna all'evento",
    goToHome: "Vai alla Home",
    verificationError: "Pagamento da verificare",
    verificationErrorDesc: "Riprova tra qualche istante.",
    paymentConfirmedToast: "Pagamento confermato",
    paymentConfirmedToastDesc: "Sei ufficialmente iscritto all'evento.",
    membershipActivatedTitle: "Tessera attivata",
    membershipActivatedDesc: "Pagamento confermato. Ora puoi completare l'iscrizione all'evento.",
    membershipActivatedToast: "Tessera attivata",
    membershipActivatedToastDesc: "Pagamento confermato. Ora puoi completare l'iscrizione all'evento.",

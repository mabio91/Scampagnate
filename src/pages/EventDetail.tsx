      ...
      >
        ...
        >
          <OptimizedImage
            src={imageSrc}
            alt={event.title}
            className={`h-full w-full object-cover bg-muted/30 transition-all duration-300 ${isSoldOut ? "grayscale" : ""}`}
            loading="eager"
          />
        </div>
        <div
        ...
        <DialogContent className="max-w-[calc(100vw-2rem)] sm:max-w-xs">
          ...
          <div className="space-y-2">
            <Button
              ...
              onClick={() => { setShowOrganizerContact(false); navigate(`/organizer/${event.organizer_id}`, { state: { role: "Organizzatore" } }); }}
            >
